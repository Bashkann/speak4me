...
function Empty({ title, detail }: { title: string; detail: string }) { return <EmptyState icon={title.includes('rooms') ? '◌' : '✓'} title={title} detail={detail} />; }
